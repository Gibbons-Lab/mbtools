...
denoised <- files %>% preprocess(config$preprocess) %>%
...
Here we see that we have identified that there are 20 ASVs in the Mock sample
which is the exact number of strains in that sample.
