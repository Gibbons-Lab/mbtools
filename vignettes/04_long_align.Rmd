---
title: "5- Long read data - alignments"
output:
...
`mbtools` has support for aligning long metagenomic reads for *Oxford Nanopore* data. Before proceeding we recommend you preprocess the reads first as described in an earlier vignette.
